import './Heritagecontent.css';

const Heritagecontent = () => {
    return (
        <p className="heritageContent">Founded in 2007, we started as a trio of architects. Our complimentary skills and relentless attention to detail turned Arch into one of the most sought after boutique firms in the country.<br/><br/>
